        ...
        rust_analyzer = function(_, opts)
          require("lazyvim.util").lsp.on_attach(function(client, buffer)
            ...
            if client.name == "rust_analyzer" then
              vim.keymap.set("n", "<C-k>", "<cmd>RustHoverActions<cr>", { buffer = buffer, desc = "Hover Actions (Rust)" })
              -- vim.keymap.set("n", "<leader>ca", "<cmd>RustCodeAction<cr>", { buffer = buffer, desc = "Code Action (Rust)" })
              vim.keymap.set("n", "<leader>xr", "<cmd>RustDebuggables<cr>", { buffer = buffer, desc = "Run Debuggables (Rust)" })
            end
          end)
